...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='9a60a803bba2cd', description="Username for SMTP server")
    smtp_password: str = Field(default='34f46ee1833d82', description="Password for SMTP server")
